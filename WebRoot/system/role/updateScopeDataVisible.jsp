...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <form id="listForm" action="<%=path%>/system/role/toUpdateScopeDataVisible.v" method="post">
    ...
    $(document).ready(function(){
      ...
      <s:iterator id="scopeDataVisible" value="scopeDataVisibleList">
        <s:if test="#scopeDataVisible.visible==@com.platform.constants.StringConstant@TRUE">
          loadSee('<s:property value="#scopeDataVisible.webId"/>', 'T')
        </s:if>
      </s:iterator>
    });
    ...
    function changeVisible(visible) {
      ...
      $.ajax({
        url : '<%=path%>/system/ajax/updateScopeDataVisible.v',
        data : datas,
