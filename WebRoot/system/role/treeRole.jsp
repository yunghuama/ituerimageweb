...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    var setting = {
    	...
    	zNodes.push({ id:'<s:property value="#role.id"/>', pId:'<s:property value="#role.superId"/>', name:'<s:property value="#role.name"/>'});
    	</s:iterator>
      function treeOnClick(event,treeId,treeNode)
      {
        parent.mainFrame.location = "<%=path%>/system/role/listPagination.v?roleId="+treeNode.id;
      }   
