...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <s:include value="/share/btMask.jsp" />
  	<div id="toolbar"></div>
  	<form id="listForm" action="<%=path%>/csms/district/listPagination.v" method="post">
      ...
      <table id="dataTable" cellpadding="0" cellspacing="0">
        <s:iterator id="district" value="page.list" status="i">
          <tr class="row">
            <td class="num"><s:property value="#i.index+1"/></td>
            <td class="box">
                <input type="checkbox" name="idList" value="<s:property value="#district.id"/>"/>
            </td>
            <td><span><s:property value="#district.name"/>&nbsp;</span></td>
          </tr>
        </s:iterator>
      </table>
    ...
    $(document).ready(function(){
      ...
      new Toolbar({
        ...
        items : [{
          ...
          handler:function(){
            top.districtFunctions.openSaveDistrictWindow();
          }
        },'-',{
          type : 'button',
          text : '修改',
          ...
          handler : function(){
            if(getFirstID()) {
              top.districtFunctions.openUpdateDistrictWindow(getFirstID());
            }
          }
        },'-',{
          type : 'button',
