  ...
  <body>
    <form name="numberForm" id="numberForm" action="<%=path%>/csms/number/update.v" class="form" method="post">
      ...
      <tr>
          ...
          <td class="form-right"><s:textfield type="text" class="text" name="number.name" id="name"/> </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="form-right"><s:textfield type="text" class="text" name="number.remark" id="remark"/></td>
        </tr>
        <tr>
          <td class="form-left"><span class="form-required">*</span>号码</td>
          <td class="form-right"><s:textfield type="text" class="text" name="number.number" id="number"/> </td>
        </tr>
      </table>
      <s:hidden name="tabId"/>
