...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <s:include value="/share/btMask.jsp" />
  	<div id="toolbar"></div>
  	<form id="listForm" action="<%=path%>/csms/warn/listPagination.v" method="post">
      ...
      <table id="dataTable" cellpadding="0" cellspacing="0">
        <s:iterator id="warn" value="page.list" status="i">
          <tr class="row">
            <td class="num"><s:property value="#i.index+1"/></td>
            <td class="box">
                <input type="checkbox" name="idList" value="<s:property value="#warn.id"/>"/>
            </td>
            <td><span><s:property value="#warn.cpu"/>%&nbsp;</span></td>
            <td><span><s:property value="#warn.memusage"/>M&nbsp;</span></td>
            <td><span><s:property value="#warn.memtotal"/>M&nbsp;</span></td>
            <td align="center"><span><s:property value="#warn.createtime" />&nbsp;</span></td>
          </tr>
        </s:iterator>
      </table>
      <s:hidden name="type"/>
    ...
    $(document).ready(function(){
      ...
      new Toolbar({
        ...
        items : [{
            type:'button',
            text:'删除',
            useable : '<s:property value="@com.platform.util.Meta@getOperate(\"syswarn_delete\")"/>',
            position: {
           	   a: '-20px 0px',
               b: '-20px -120px'
            },
