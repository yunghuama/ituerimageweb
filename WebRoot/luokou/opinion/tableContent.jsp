...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <s:include value="/share/btMask.jsp" />
  	<div id="toolbar"></div>
  	<form id="listForm" action="<%=path%>/csms/opinion/listPagination.v" method="post">
        ...
        <s:iterator id="content" value="page.list" status="i">
          <tr class="row">
            ...
            <td><span><s:property value="#content.createTime"/>&nbsp;</span></td>
             <td><span><s:property value="#content.number"/>&nbsp;</span></td>
            <td><span title='<s:property value="#content.content"/>'><s:property value="#content.content"/>&nbsp;</span></td>
          </tr>
        </s:iterator>
      </table>
      <s:hidden name="type"/>
        ...
        items : [{
          ...
          handler : function(){
            validateBeforeDelete({
              ...
              deleteURL : '<%=path%>/csms/opinion/delete.v'
            });
          }
        }]
      });
          ...
          handler : function(){
            ...
            $.prompt(txt,{
              ...
              callback: function(v,m) {
                if(v) {
                  window.location = '<%=path%>/csms/opinion/delete.v?idList='+id;
                }
              }
            });
          }
