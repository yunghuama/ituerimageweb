...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <form name="numberForm" id="enterpriseForm" action="<%=path%>/csms/enterprise/save.v" class="form" method="post">
      ...
      <table class="form-table" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td class="form-right"><input type="text" class="text" name="enterprise.name" id="name"/> </td>
        </tr>
        <tr>
          <td class="form-left"><span class="form-required">*</span>手机号码</td>
          <td class="form-right"><input type="text" class="text" name="enterprise.number" id="number"/></td>
        </tr>
        <tr>
          <td class="form-left"><span class="form-required">*</span>集团编码</td>
          <td class="form-right"><input type="text" class="text" name="enterprise.code" id="code"/></td>
        </tr>
        <tr>
