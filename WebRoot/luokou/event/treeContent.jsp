...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    var setting = {
    	...
    	zNodes.push({ id:'0', pId:'-1', name:'商户'});
    	zNodes.push({ id:'1', pId:'-1', name:'员工'});
      function treeOnClick(event,treeId,treeNode)
      {
        parent.mainFrame.location = "<%=path%>/csms/message/listPagination.v?type="+(treeNode.id=="-1" ? "" :  treeNode.id);
      }   
