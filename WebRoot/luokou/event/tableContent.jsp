...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <s:include value="/share/btMask.jsp" />
  	<div id="toolbar"></div>
  	<form id="listForm" action="<%=path%>/csms/event/listPagination.v" method="post">
    ...
    $(document).ready(function(){
      ...
      new Toolbar({
        ...
        items : [{
          ...
          handler:function(){
            top.eventFunctions.openSaveContentWindow();
          }
        },'-',{
            type:'button',
            text:'查看',
            ...
            handler:function(){
              if(getFirstID())
              top.eventFunctions.openViewContentWindow(getFirstID());
            }
          },'-',{
          type : 'button',
          text : '删除',
          ...
          handler : function(){
            validateBeforeDelete({
              ...
              deleteURL : '<%=path%>/csms/event/delete.v'
            });
          }
        }]
      });
