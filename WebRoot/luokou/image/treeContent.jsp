...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    var setting = {
        ...
        <s:iterator id="content" value="categoryList" status="st">
    	zNodes.push({ id:'<s:property value="#content.id"/>', pId:'<s:property value="#content.superId"/>', name:'<s:property value="#content.name"/>'});
    	</s:iterator>
      function treeOnClick(event,treeId,treeNode)
      {
        parent.mainFrame.location = "<%=path%>/csms/image/listPagination.v?categoryId="+treeNode.id;
      }   
