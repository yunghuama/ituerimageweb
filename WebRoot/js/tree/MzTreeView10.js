...
MzTreeView.prototype.setStyle = function()
{
  ...
  */
  var style = "<style>"+
  "DIV.MzTreeView DIV IMG{border: 0px solid #FFFFFF; vertical-align:top;}"+
  "DIV.MzTreeView DIV SPAN IMG{border: 0px solid #FFFFFF; vertical-align:top;}"+
  "DIV.MzTreeView DIV A{color:#444444; text-decoration:none; font-size: 13px; padding-left:3px;}";
  //if(this.wordLine)
  if(false)
  {
    style +="\
