 ...
 */
jQuery.extend({	
	ImpromptuDefaults: { prefix:'jqi', buttons:{ Ok:true }, loaded:function(){}, submit:function(){return true;}, callback:function(){}, opacity:0.5, zIndex: 999, overlayspeed:1, promptspeed:'fast', show:'show', focus:0, useiframe:false },
	...
	prompt: function(m,o){
      ...
      var hcenter = ((b.height()/2 - jqi.get(0).offsetHeight/2)<=0)?0:"10%";
			...
			jqi.css({ position: "absolute", top: hcenter, left: "50%", marginLeft: ((((jqi.css("paddingLeft").split("px")[0]*1) + jqi.width())/2)*-1) });					
		};
